...
global.syt = 'https://youtu.be/nigga'
global.sgh = 'https://github.com/idk'
...
global.namebot = 'Arthawanbotss2ラ'
global.nameown = 'ᴹᴿ᭄ RAMS ×፝֟͜×'


/*============== STAFF ==============*/
global.owner = [
  ['6289651957561', 'ᴹᴿ᭄ RAMS ×፝֟͜×', 'true']
...
/*============== WATERMARK ==============*/
global.wm = 'Arthawanbotss2ラ | By ᴹᴿ᭄ RAMS ×፝֟͜×' //Main Watermark
global.wm2 = 'ᴹᴿ᭄ RAMS ×፝֟͜×'
global.wm3 = 'Arthawanbotss2ラ | By ᴹᴿ᭄ RAMS ×፝֟͜×'
global.botdate = `⻝ 𝗗𝗮𝘁𝗲: ${week} ${date}\n⻝ 𝗧𝗶𝗺𝗲: ${wktuwib}`
global.bottime = `⻝ 𝗧 𝗜 𝗠 𝗘 : ${wktuwib}`
global.titlebot = `Yuki Adistyラ | ʙʏ ${global.nameown}`
global.author = 'ᴹᴿ᭄ RAMS ×፝֟͜×' 
global.packname = 'ᴹᴿ᭄ RAMS ×፝֟͜×'
...
/*============== GLOBAL BIO ==============*/
global.nameowner = 'Arthawanbotss2ラ'
global.umurowner = '22'
